...
var Verify = function (props) {
    ...
    var email = ((_a = router.query) === null || _a === void 0 ? void 0 : _a.email) || false;
    var uuid = ((_b = router.query) === null || _b === void 0 ? void 0 : _b.uuid) || false;
    var _c = react_1.useState(false), loading = _c[0], setLoading = _c[1];
    var _d = react_hook_form_1.useForm(), control = _d.control, errors = _d.formState.errors, handleSubmit = _d.handleSubmit, reset = _d.reset;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    data.uuid = uuid;
                    setLoading(true);
                    return [4 /*yield*/, Auth_1["default"].verify(data)];
                case 1:
                    result = _a.sent();
                    setLoading(false);
                    ...
                    <div className="p-col-12 p-md-6 p-md-offset-3">
                        <card_1.Card className={"p-mt-3"}>
                            <tabview_1.TabView className={AuthLayout_module_scss_1["default"].tabView} activeIndex={0}>
                                <tabview_1.TabPanel header="Xác nhận tài khoản">
                                    <div className="card">
