...
var Container_1 = require("@/src/components/PostForm/Container");
...
exports.getServerSideProps = store_1.wrapper.getServerSideProps(function (context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                account = _d.sent();
                if (!((_c = account === null || account === void 0 ? void 0 : account.data) === null || _c === void 0 ? void 0 : _c.phone_verified_at)) {
                    return [2 /*return*/, {
                            redirect: {
                                permanent: false,
