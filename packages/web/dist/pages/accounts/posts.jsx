...
var Post_1 = require("@/src/components/AccountPost/Post");
...
var Login = function (props) {
    ...
    return (<Master_1.default>
      <Layout_1.default contentClass="p-col-12 p-md-9 p-lg-9">
        <Post_1.default />
      </Layout_1.default>
    </Master_1.default>);
};
exports.getServerSideProps = store_1.wrapper.getServerSideProps(function (context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                account = _c.sent();
                return [4 /*yield*/, context.store.dispatch(accountsAction_1.fetchAccountPostsRequest({
                        token: token,
                        isServer: true
                    }))];
            case 2:
